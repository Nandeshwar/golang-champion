...
var file_book_proto_rawDesc = []byte{
	...
	0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x72, 0x32, 0xb5, 0x01, 0x0a, 0x04, 0x42, 0x6f, 0x6f,
...
var file_book_proto_depIdxs = []int32{
	...
	0, // 1: proto.Book.GetBookInfoBidirectional:input_type -> proto.GetBookInfoReq
	1, // 2: proto.Book.GetBookInfo:output_type -> proto.GetBookInfoResponse
	1, // 3: proto.Book.GetBookInfoBidirectional:output_type -> proto.GetBookInfoResponse
